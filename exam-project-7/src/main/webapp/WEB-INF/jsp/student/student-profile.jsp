		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-lg-4 col-sm-8 col-sm-offset-2 col-lg-offset-0 profile-info ">
					...
					<h6 class="text-center">Usertype: Student</h6>
				</div>
	...
	<div class="panel">
		<div class="panel-heading">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#recent-activity"> <i
						class="glyphicon glyphicon-home"></i> Daily Activity
				</a></li>
				<li><a data-toggle="tab" href="#profile"> <i class="glyphicon glyphicon-user"></i> Profile
				</a></li>
				<li class=""><a data-toggle="tab" href="#edit-profile"> <i class="icon-envelope"></i> Edit
						Profile
				</a></li>
			</ul>
		</div>

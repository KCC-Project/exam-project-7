...
<div id="page-content-wrapper">
	<ol class="breadcrumb">
		...
		<li><a><span class="glyphicon glyphicon-education black"> Exam</span></a></li>
		<li><a><span class="glyphicon glyphicon-education black"> Student Exam</span></a></li>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="form-group col-sm-4" style="margin-bottom: 0px;">
								<select required class="form-control" name="semester" id="p-semester-box">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="form-group col-sm-4" style="margin-bottom: 0px;">
								<select required class="form-control" name="subject_id" id="p-subject-box">
									<option value="" disabled selected>Select Subject</option>
								</select>
							</div>
							<div class="form-group col-sm-4" style="margin-bottom: 0px;">
								<select required class="form-control" name="subject_id" id="p-Exam-Type-box">
	...
	<form id="student-exam-edit-form" method="post" class="form-horizontal well" style="display: none;">
		<div class="form-group">
			<label class="col-md-3 control-label">Student-Exam Detail</label>
			<div class="col-md-9">
				<div class="col-md-6">
					Student_ID:<input type="text" class="form-control" name="s_id" disabled="disabled" />
				</div>
				<div class="col-md-6">
					Exam_Id<input type="text" class="form-control" name="exam_id" disabled="disabled" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9">
				...
				</label> <label> Present <input type="radio" value=1 name="attendance">
				</label>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-12">
				<button type="submit" id="updateStudentExam" class="btn btn-info btn-block">Update</button>
			</div>
		</div>
	</form>
